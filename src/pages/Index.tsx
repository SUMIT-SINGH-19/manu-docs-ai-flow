            ...
            <Card className="shadow-medium border-0 bg-gradient-primary overflow-hidden">
              <CardContent className="p-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                  <div>
                    <Badge variant="secondary" className="bg-white/20 text-ai-accent-foreground border-white/30 mb-4">
                      🚀 New Feature
                    </Badge>
                    ...
                    <div className="grid grid-cols-3 gap-4 text-center">
                      <div>
                        <div className="text-2xl font-bold text-ai-accent-foreground mb-1">&lt;60s</div>
                        <div className="text-xs text-ai-accent-foreground/80">Processing Time</div>
                      </div>
                      <div>
                        <div className="text-2xl font-bold text-ai-accent-foreground mb-1">500-800</div>
                        <div className="text-xs text-ai-accent-foreground/80">Words Summary</div>
                      </div>
                      <div>
                        <div className="text-2xl font-bold text-ai-accent-foreground mb-1">24h</div>
                        <div className="text-xs text-ai-accent-foreground/80">Auto-Delete</div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center space-x-3 p-3 bg-white/20 rounded-lg">
                          ...
                          <div className="flex-1">
                            <h4 className="font-medium text-ai-accent-foreground">Upload Documents</h4>
                            <p className="text-sm text-ai-accent-foreground/80">PDF, Word, Text files</p>
                          </div>
                          <CheckCircle className="w-5 h-5 text-ai-accent-foreground" />
                        </div>
                        <div className="flex items-center space-x-3 p-3 bg-white/15 rounded-lg">
                          <div className="w-10 h-10 bg-white/20 text-ai-accent-foreground rounded-full flex items-center justify-center">
                            <Bot className="w-5 h-5" />
                          </div>
                          <div className="flex-1">
                            <h4 className="font-medium text-ai-accent-foreground">AI Processing</h4>
                            <p className="text-sm text-ai-accent-foreground/80">Extracting key insights...</p>
                          </div>
                          <div className="w-2 h-2 bg-white rounded-full animate-pulse" />
                        </div>
                        <div className="flex items-center space-x-3 p-3 bg-white/5 rounded-lg opacity-60">
                          <div className="w-10 h-10 bg-white/20 text-ai-accent-foreground rounded-full flex items-center justify-center">
                            <FileText className="w-5 h-5" />
                          </div>
                          <div className="flex-1">
                            <h4 className="font-medium text-ai-accent-foreground">WhatsApp Delivery</h4>
                            <p className="text-sm text-ai-accent-foreground/80">Formatted PDF summary</p>
                          </div>
                        </div>
                      </div>
                    </div>
